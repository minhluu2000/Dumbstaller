...
class NetworkDataHandler:
    ...
    def net_data_input(self, input_path):
        """This method pull data from a database for search, view the entire data base, or auto network config."""
        ...
        with open(self.input_path, "r") as f:
            ...
            for row in reader: # put the csv data to data list
                # return = [Host name, Adapter, IPv4, Subnet, Default Gateway, DNS 1, DNS 2]
...
class NetworkConfig:
    ...
    def data_send(self):
        """This method returns all the data of an instance of NetworkConfig. It's mainly used to pass data to NetworkDataHandler for output"""
        data = [self.hostname, self.adapter, self.ip4, self.ip4_subnet, self.gateway, self.dns1, self.dns2]
        return data
